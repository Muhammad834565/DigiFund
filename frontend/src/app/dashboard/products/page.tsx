...
import { useGetMyInventoryQuery, GetMyInventoryQuery } from "@/graphql/generated/graphql";
...
export default function ProductsPage({
  ...
  if (inventoryError) return <p>Error loading data: {inventoryError?.message}</p>;

  const inventory = inventoryData?.getInventory || [];
  const products = inventory.map((item: GetMyInventoryQuery['getInventory'][number]) => ({
